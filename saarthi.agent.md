...
1. Resolve framework home from the VS Code user prompts root:
	`<user-prompts-root>/saarthi-framework`
   (the `saarthi-framework` folder that sits next to this agent file).
